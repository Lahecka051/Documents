...
<p align="center"><sub>Figure 1 — PI·NTK-aware·NTK-by-parts에서 YaRN으로 이어지는 확장 흐름</sub></p>
...
\begin{aligned}
Q,K,V&:\ [B,H,N,d_h],\\
\mathrm{inv\_freq}&:\ [d_h/2],\\
\mathrm{wavelength}&:\ [d_h/2],\\
r=L/\mathrm{wavelength}&:\ [d_h/2],\\
\mathrm{ramp}\gamma&:\ [d_h/2],\\
\text{scaled }\mathrm{inv\_freq}&:\ [d_h/2],\\
\cos,\sin&:\ [N,d_h],\\
