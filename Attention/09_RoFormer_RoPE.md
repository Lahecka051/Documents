...
![같은 위치 이동에 대한 RoPE 내적의 불변성](assets/09_rope_common_shift_invariance.png)
...
![RoPE의 주파수별 회전 패턴과 논문의 장거리 감쇠 proxy](assets/09_rope_frequencies_and_decay.png)
...
![Attention 계산 안에서 RoPE가 적용되는 위치](assets/09_rope_attention_pipeline.png)
