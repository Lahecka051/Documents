...
$$
S_\tau(U,V)=\mathrm{softmax}_{row}\left(\frac{UV^\top}{\tau}\right)\in\mathbb{R}^{b\times b}.
$$
...
$$
\mathcal{L}_{final}
=\sum_{B\in\lbrace B_{real},B_{syn}\rbrace}\mathcal{L}_{Total}(B).
$$
...
| Variant | Channels $\lbrace C_1,C_2,C_3,C_4\rbrace$ | Depths $\lbrace L_1,L_2,L_3,L_4\rbrace$ |
|---|---|---|
