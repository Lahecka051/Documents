...
```math
W = \operatorname{TextEncoder}(t_1,\ldots,t_C)
...
=
\alpha\,
\operatorname{L2Norm}(e_k)
\operatorname{L2Norm}(w_j)^{\top}
+\beta
```
...
```math
W'=W+\operatorname{MultiHeadAttention}(W,\widetilde X,\widetilde X)
```
