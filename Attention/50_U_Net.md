...
```math
Z_l=\operatorname{Concat}
\left(
\operatorname{Up}(D_{l+1}),
\operatorname{Crop}(E_l)
\right)
```

```math
D_l=\operatorname{Conv}_{3\times3}
\left(
\operatorname{Conv}_{3\times3}(Z_l)
\right)
```
