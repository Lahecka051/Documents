...
![Sparse Transformer의 strided·fixed attention pattern](https://github.com/user-attachments/assets/d2b154ca-711a-41e5-af4c-343b6994ddfb)
...
```text
A_i^(local)  = { j : i-l < j <= i }
A_i^(stride) = { j : j <= i and (i-j) mod l = 0 }
```
