...
![BigBird의 local·random·global sparse attention graph](https://github.com/user-attachments/assets/4299e34d-96c8-43db-bc1b-c68c7465104c)
...
```text
R_i = random subset of positions, |R_i| = r
```
