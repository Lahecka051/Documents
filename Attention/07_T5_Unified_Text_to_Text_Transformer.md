...
<p align="center"><sub>Figure 1 — 여러 NLP task를 하나의 text-to-text 형식으로 통일한 T5</sub></p>
...
```math
\begin{aligned}
\text{corrupted tokens}&=500\times0.15=75,\\
\text{mean span length}&=3,\\
\text{number of spans}&\approx75/3=25.
\end{aligned}
```
