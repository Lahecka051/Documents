...
<p align="center"><sub>Figure 1 원본·확대 패널 — warpgroup ping-pong scheduling과 GEMM-softmax 중첩</sub></p>
...
```math
x_{\mathrm{FP8}}=\mathrm{round}\!\left(\frac{x}{\mathrm{scale}_{\mathrm{block}}}\right)
```
